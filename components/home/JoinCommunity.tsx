        ...
        {data.items.map((item, i) => {
          return (
            <div key={item.title} className="flex w-full flex-col items-center text-center md:w-1/3 px-2 md:px-0">
              <h4 className="mb-4 flex items-baseline text-font-accent text-h4 font-baskerville gap-4">
                <span className="text-5xl font-bold text-primary-700 font-baskerville-bold">0{i + 1}</span>
