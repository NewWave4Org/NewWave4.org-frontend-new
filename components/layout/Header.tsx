...
const Header = ({ currentLocale }: { currentLocale: string }) => {
  ...
  return (
    <>
            ...
            <div className={`flex items-center justify-between flex-1`}>
              ...
              <div className="flex items-center lg:order-2 gap-x-4">
                ...
                <Link
                  href="/donation"
                  prefetch={false}
                  className="donate-btn custom-donate-btn flex items-center"
                >
                  Donate
      ...
      {isMobile && (
        <div
          className={`${isMobile ? 'headerMobile' : ''} ${isMenuShow ? 'headerShowMobile' : ''}`}
        >
          <Menu handleToggleMenu={handleToggleMenu} />
          <div className="flex items-start flex-col lg:order-2 gap-x-4 mt-5">
            ...
            <Link
              href="/donation"
              className="donate-btn custom-donate-btn flex items-center mt-5"
            >
              Donate
