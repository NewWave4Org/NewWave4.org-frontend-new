...
const adminMenu = [
  {id: '1', title: 'User management', icon: <UsersIcon />, href: adminLinkSidebar.ADMIN_USERS, allowedToAdmin: true },
  {id: '2', title: 'Pages', icon: <PagesIcon />, href: adminLinkSidebar.ADMIN_PAGES, allowedToAdmin: false},
  {id: '3', title: 'Articles', icon: <ArticlesIcon />, href: adminLinkSidebar.ADMIN_ARTICLES, allowedToAdmin: false},
  {id: '4', title: 'Archived page', icon: <BasketIcon />, href: adminLinkSidebar.ADMIN_ARCHIVE, allowedToAdmin: false},
];
