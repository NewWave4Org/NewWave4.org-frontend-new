    ...
    <div className="paginationBlock mt-6">
      <div className="container px-4 mx-auto">
          ...
          >
            ...
            <button
              type="button"
              className="flex leading-[1.7] items-center justify-center bg-none p-1 h-[32px] px-1 min-w-[32px] text-medium2 text-font-primary rounded-lg hover:bg-primary-500 hover:text-white duration-500"
            >
              2
            </button>
            <button
