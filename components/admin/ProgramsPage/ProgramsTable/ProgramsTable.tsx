...
interface IProjectsTableProps {
  ...
  programs: GetArticleByIdResponseDTO[];
  totalPages: number;
  currentPage: number;
  changePage: (page: number) => void;
...
function ProgramsTable({ renderPagination, programs, totalPages, currentPage, changePage, handleArchivedProject, handleDeleteProject }: IProjectsTableProps) {
                ...
                <td className="pr-3 py-6">
                  <div className="flex gap-x-3 justify-end">
                    ...
                    <Button
                      ...
                      className="!text-admin-700 !py-2 bg-white h-auto flex items-center font-bold shadow-md
                      active:bg-transparent active:!text-admin-700 hover:shadow-lg duration-500"
                      onClick={() => handleDeleteProject(program)}
                    >
                      <div className="mr-1">
                    ...
                    {articleStatus === ArticleStatusEnum.PUBLISHED && (
                      <Button
                        ...
                        className="!text-admin-700 !py-2 bg-white h-auto flex items-center font-bold shadow-md
                      active:bg-transparent active:!text-admin-700 hover:shadow-lg duration-500"
                        onClick={() => handleArchivedProject(program)}
                      >
                        <div className="mr-1">
