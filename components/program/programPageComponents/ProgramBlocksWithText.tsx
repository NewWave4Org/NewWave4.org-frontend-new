      ...
      <div className="content">
        <div className="container mx-auto px-4">
          {contentBlock?.map((content, index) => {
            const htmlText1 = convertDraftToHTML(
              content?.translatable_text_editorState1,
              locale,
            );
            const htmlText2 = convertDraftToHTML(
              content?.translatable_text_editorState2,
              locale,
            );
            ...
            return (
              <div key={index} className="pt-3 lg:mb-20 mb-10">
                ...
                <div className="flex lg:flex-row flex-col gap-4">
                  <div
                    className="text-body lg:w-1/2 w-full text-font-primary"
