    ...
    <div className="container mx-auto px-4">
      {contentBlock?.map((content, index) => {
        ...
        return (
          <div
            key={index}
            className={`flex lg:flex-row flex-col lg:mb-20 mb-10 gap-x-3 ${oddBlock ? 'odd' : ''}`}
          >
            <div
              className={`flex-1 lg:pr-[64px] lg:pb-0 pr-0 pb-5 ${oddBlock ? 'lg:order-2 order-1 !pr-0 lg:pl-10 pl-0' : ''}`}
            >
