...
const Button: React.FC<ButtonProps> = ({
  ...
  if (variant === 'primary') {
    buttonStyle +=
      'bg-primary-50 text-font-white duration-500 hover:bg-buttons-cta-hover active:bg-buttons-cta-active active:text-font-white disabled:bg-icons-grey disabled::text-font-white ';
