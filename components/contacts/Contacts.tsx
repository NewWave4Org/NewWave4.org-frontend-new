      ...
      <div className="contacts-section">
        <div className="flex flex-col justify-between max-w-[399px]">
          <div className="flex flex-col gap-y-4 lg:mb-0 mb-4">
            <h3 className="text-h3 text-font-primary font-ebGaramond">Зв’яжіться з нами</h3>
            <p className="text-body text-font-primary">Маєте запитання? Заповніть форму або зв’яжіться зручним для вас способом</p>
          </div>
          <div className="flex flex-col gap-y-4 lg:mb-0 mb-4">
            ...
            <div className="inline-flex gap-x-2">
              ...
              <p className="text-body text-grey-700">Бруклін-Статен Айленд, Нью Йорк</p>
            </div>
          </div>
