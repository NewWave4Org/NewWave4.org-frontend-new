...
const commonData = {
  uk: {
    ...
    history_card: {
      ...
      card: {
        ...
        title:
          '"Нова Українська Хвиля" – це Всеамериканське громадське об\'єднання, яке з 2006 року об’єднує українців у США, допомагаючи їм адаптуватися, зберігати національну ідентичність та підтримувати Україну.',
        items: [
  ...
  en: {
    detailed_text_information: {
      top: [
        'The All-American public organization «New Ukrainian Wave» is a national-patriotic and educational-cultural community that unites people from Ukraine, primarily representatives of the 4th wave of emigration.',
      ],
      bottom: [
        'We work to preserve Ukrainian culture, traditions, and national identity, promote the unity of the Ukrainian community, and support the development of Ukrainian education and civic activism',
      ],
    },
  },
};
