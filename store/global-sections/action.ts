...
} from '@/utils/global-sections/type/interfaces';
import { normalizeApiError } from '@/utils/http/normalizeApiError';
import { createAsyncThunk } from '@reduxjs/toolkit';

export const createdGlobalSection = createAsyncThunk(
  'global-section/create',
  async (data: IGlobalSectionsRequestDTO, { rejectWithValue }) => {
    try {
...
export const getAllGlobalSections = createAsyncThunk(
  'global-srction/all',
...
export const getGlobalSectionByKey = createAsyncThunk(
  'global-section/one-by-key',
...
export const updateGlobalSection = createAsyncThunk(
  'global-section/update',
  async (
    { id, data }: { id: number; data: IGlobalSectionRequestPutDTO },
    { rejectWithValue },
  ) => {
    try {
