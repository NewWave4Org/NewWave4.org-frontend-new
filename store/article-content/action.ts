...
export const deleteArticle = createAsyncThunk(
  'article-content/deleteArticle',
  async (
    { id, articleType }: { id: number; articleType: ArticleType },
    { rejectWithValue },
  ) => {
    try {
      const response = await articleContentService.deleteArticle({
        id,
        articleType,
      });
...
export const getArticleById = createAsyncThunk(
  'article-content/getArticleById',
...
export const getAllArticle = createAsyncThunk(
  ...
  async (
    ...
    try {
      const response = await articleContentService.getAllArticle({
        page,
        size,
        articleType,
        articleStatus,
...
export const createNewArticle = createAsyncThunk(
  'article-content/createNewArticle',
  async (data: CreateNewArticleRequestDTO, { rejectWithValue }) => {
    try {
...
export const publishArticle = createAsyncThunk(
  'article-content/publishArticle',
  async (id: number, { rejectWithValue }) => {
    try {
...
export const updateArticle = createAsyncThunk(
  ...
  async ({ id, data }: UpdateArticleRequestDTO, { rejectWithValue }) => {
    try {
...
export const archivedArticle = createAsyncThunk(
  'article-content/archivedArticle',
  async (
    { id, articleType }: { id: number; articleType: ArticleType },
    { rejectWithValue },
  ) => {
    try {
      const response = await articleContentService.archivedArticle({
        id,
        articleType,
      });
