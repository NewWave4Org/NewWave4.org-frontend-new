...
export const becomeParthner = createAsyncThunk(
  'becomeParthner',
  async (data: BecomeParthnerRequestDTO, { rejectWithValue }) => {
    try {
...
export const confirmSubscribe = createAsyncThunk(
  'confirmSubscribe',
...
export const confirmUnsubscribe = createAsyncThunk(
  'confirmUnsubscribe',
