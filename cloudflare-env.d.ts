/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 9ec58e6db24368dcfb21cf1eaa323bab)
...
interface __BaseEnv_CloudflareEnv {
  ...
  NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEYS: string;
  NEXT_PUBLIC_STRIPE_WEBHOOK_URL: string;
  NEXT_PUBLIC_NEWWAVE_API_URL: string;
  NEXT_PUBLIC_SITE_URL: string;
  WORKER_SELF_REFERENCE: Fetcher /* newwave4-frontend-staging */;
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | 'NEXT_PUBLIC_STRIPE_WEBHOOK_URL'
